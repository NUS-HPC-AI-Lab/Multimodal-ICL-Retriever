...
from src.util.collators import IBNDataCollatorWithPadding
...
class RetrieverTrainer:
    ...
    def __init__(self, cfg) -> None:
        ...
        self.metric = load_metric('open_flamingo/src/metrics/accuracy.py')
...
@hydra.main(config_path="open_flamingo/config", config_name="retriever_trainer")
def main(cfg):
    logger.info(cfg)
    set_seed(43)
